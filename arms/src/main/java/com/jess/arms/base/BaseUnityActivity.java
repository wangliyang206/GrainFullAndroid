...
import com.jess.arms.utils.StatusBarCompatUtils;
 ...
 * 继承于这个特定的 {@link Activity}, 然后再按照 {@link BaseUnityActivity} 的格式, 将代码复制过去, 记住一定要实现{@link IActivity}
 *
 ...
 * ================================================
 */
public abstract class BaseUnityActivity<P extends IPresenter> extends UnityPlayerActivity implements IActivity, ActivityLifecycleable, BGASwipeBackHelper.Delegate {
