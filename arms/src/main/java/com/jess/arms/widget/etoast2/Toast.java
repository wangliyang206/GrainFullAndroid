package com.jess.arms.widget.etoast2;
...
/**
 * 使用方法：Toast.makeText(getApplicationContext(), text, EToast2.LENGTH_SHORT).show();
 * Author: Blincheng.
 * Date: 2017/6/30.
 * Description:
 */
...
public class Toast {
    ...
    public static Toast makeText(Context context, String message) {
        return new Toast(context, message, EToast2.LENGTH_SHORT);
    }

    public static Toast makeText(Context context, int resId) {
        return new Toast(context, resId, EToast2.LENGTH_SHORT);
    }
