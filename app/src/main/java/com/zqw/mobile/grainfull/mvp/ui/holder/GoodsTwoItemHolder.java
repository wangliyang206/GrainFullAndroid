 ...
 * ================================================
 */
public class GoodsTwoItemHolder extends BaseHolder<GoodsBean> implements View.OnClickListener {
    @BindView(R.id.fragment_homegoodssecond_item)
    LinearLayout mLayout;

    @BindView(R.id.imvi_homegoodsseconditem_secondImg)
    ImageView imviIcon;
    @BindView(R.id.txvi_homegoodsseconditem_tag)
    TextView txviTag;
    @BindView(R.id.txvi_homegoodsseconditem_des1)
    TextView txviDes1;
    @BindView(R.id.txvi_homegoodsseconditem_des2)
    TextView txviDes2;
    @BindView(R.id.txvi_homegoodsseconditem_enter)
    TextView txviEnter;
    ...
    public GoodsTwoItemHolder(View itemView) {
        super(itemView);
...
//        }
        ...
        txviTag.setText(CommonUtils.isEmptyReturnStr(data.getTag()));
        txviDes1.setText(CommonUtils.isEmptyReturnStr(data.getDes1()));
        txviDes2.setText(CommonUtils.isEmptyReturnStr(data.getDes2()));
    }
