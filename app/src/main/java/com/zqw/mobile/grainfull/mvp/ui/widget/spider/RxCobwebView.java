package com.zqw.mobile.grainfull.mvp.ui.widget.spider;
...
public class RxCobwebView extends View {
    ...
    private void initEvent() {
        defalutSize = DensityUtils.dip2px(mContext, defalutSize);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        //蛛网等级颜色
        mSpiderLevelColor = ColorUtils.setAlphaComponent(mSpiderLevelStrokeColor, (255 / 2));
        //是否需要 蛛网等级描边
        ...
        //标题字体大小
        mSpiderNameSize = a.getDimensionPixelSize(R.styleable.RxCobwebView_spiderNameSize, DensityUtils.dip2px(mContext, 16));
        a.recycle();
    }
    ...
    private void initLevelPoints() {
        ...
        for (int i = mSpiderMaxLevel; i > 0; i--) {
            ...
            paint.setColor(ColorUtils.setAlphaComponent(mSpiderColor, (255 / (mSpiderMaxLevel + 1) * (mSpiderMaxLevel - i - 1) + 255 / scale) % 255));
            //设置实心
    ...
    private void drawCobweb(Canvas canvas, int index) {
        ...
        if (mSpiderLevelStroke) {
            if (scoreStrokePaint == null) {
                scoreStrokePaint = new Paint();
                scoreStrokePaint.setColor(ColorUtils.setAlphaComponent(levelPaintList.get(mSpiderMaxLevel - 1).getColor(), 50));
                scoreStrokePaint.setStyle(Paint.Style.STROKE);
                scoreStrokePaint.setAntiAlias(true);
                if (mSpiderLevelStrokeWidth > 0) {
                    scoreStrokePaint.setStrokeWidth(mSpiderLevelStrokeWidth);
