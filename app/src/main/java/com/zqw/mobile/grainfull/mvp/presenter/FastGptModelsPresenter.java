 ...
 */
@ActivityScope
public class FastGptModelsPresenter extends BasePresenter<FastGptModelsContract.Model, FastGptModelsContract.View> {
    @Inject
    ...
    @Inject
    public FastGptModelsPresenter(FastGptModelsContract.Model model, FastGptModelsContract.View rootView) {
