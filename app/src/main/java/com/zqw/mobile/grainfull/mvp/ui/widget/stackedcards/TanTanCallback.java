package com.zqw.mobile.grainfull.mvp.ui.widget.stackedcards;

import static com.zqw.mobile.grainfull.mvp.ui.widget.stackedcards.CardConfig.MAX_SHOW_COUNT;
import static com.zqw.mobile.grainfull.mvp.ui.widget.stackedcards.CardConfig.SCALE_GAP;
import static com.zqw.mobile.grainfull.mvp.ui.widget.stackedcards.CardConfig.TRANS_Y_GAP;
...
/*        if (isLeftSwipe){
        ...
        if (viewHolder instanceof CardItemHolder) {
            CardItemHolder holder = (CardItemHolder) viewHolder;
            holder.setAlpha(R.id.imvi_cardoverlapitemcard_like, 0);
            holder.setAlpha(R.id.imvi_cardoverlapitemcard_dislike, 0);
        }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (level > 0) {
                ...
                if (viewHolder instanceof CardItemHolder) {
                    ...
                    if (dX > 0) {
                        //露出左边，比心
                        holder.setAlpha(R.id.imvi_cardoverlapitemcard_like, xFraction);
                    } else if (dX<0){
                        //露出右边，滚犊子
                        holder.setAlpha(R.id.imvi_cardoverlapitemcard_dislike, -xFraction);
                    }else {
                        holder.setAlpha(R.id.imvi_cardoverlapitemcard_like, 0);
                        holder.setAlpha(R.id.imvi_cardoverlapitemcard_dislike, 0);
                    }
