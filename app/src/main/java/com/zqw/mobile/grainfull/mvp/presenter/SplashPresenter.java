...
//        mRootView.approved();
    ...
    private void validToken() {
        ...
        if (IS_DEBUG_DATA) {
            // 将账号密码以及常用信息保存到缓存中
            mAccountManager.updateAccountInfo(new LoginResponse("50154b09-14bd-49bf-87a7-d53ce5d29f80", "R000014", "赤槿", "18124027304"));
            // 跳转致首页
    ...
    private void initFile() {
        ...
        FileUtils.createOrExistsDir(Constant.TEMPLATE_PATH);                                        // 设置模板路径
    }
