...
import com.zqw.mobile.grainfull.mvp.ui.widget.aircraftwar.Bullet;
import com.zqw.mobile.grainfull.mvp.ui.widget.aircraftwar.Explosion;
...
public class EnemyPlane extends AutoSprite {
    ...
    //创建爆炸效果后会销毁敌机
    public void explode(AircraftWar gameView) {
        //创建爆炸效果
