...
public class ParentRecyclerView extends RecyclerView {
    ...
    private void init(Context context) {
        ...
        mMaxDistance = mFlingHelper.getVelocityByDistance((double) (ScreenUtils.getScreenHeight() * 4));
    ...
    private ChildRecyclerView findNestedScrollingChildRecyclerView() {
        if (getAdapter() != null && (getAdapter() instanceof NewHomeAdapter)) {
            return ((NewHomeAdapter) getAdapter()).getCurrentChildRecyclerView();
        }
        return null;
    }
