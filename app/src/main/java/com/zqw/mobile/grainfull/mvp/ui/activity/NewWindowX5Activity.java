...
import com.zqw.mobile.grainfull.di.component.DaggerNewWindowX5Component;
import com.zqw.mobile.grainfull.mvp.contract.NewWindowX5Contract;
import com.zqw.mobile.grainfull.mvp.presenter.NewWindowX5Presenter;
 ...
 * Description: 新窗口 X5
 * <p>
 * Created on 2023/01/16 10:42
 *
 * @author 赤槿
 * module name is NewWindowX5Activity
 */
public class NewWindowX5Activity extends BaseActivity<NewWindowX5Presenter> implements NewWindowX5Contract.View {
    /*--------------------------------控件信息--------------------------------*/
    @BindView(R.id.view_nwx5_top)
    View mTopLayout;

    @BindView(R.id.pwv_nwx5_webView)
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_new_window_x5;
    }
