...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setDuration(int duration) {
        this.mCaptureLayout.setDuration(duration);
    }
    ...
    public void confirmState(int type) {
        switch (type) {
            ...
            case TYPE_PICTURE:
                mPhoto.setVisibility(INVISIBLE);
                if (jCameraLisenter != null) {
                    jCameraLisenter.captureSuccess(imgPath, captureBitmap);
                }
                break;
            case TYPE_SHORT:
                break;
    ...
    @Override
    public void showPicture(Bitmap bitmap, boolean isVertical,String path) {
        if (isVertical) {
