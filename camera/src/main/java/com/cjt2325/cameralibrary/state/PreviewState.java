...
class PreviewState implements State {
    ...
    PreviewState(CameraMachine machine) {
        ...
        CameraInterface.getInstance().setmContext(machine.getContext());
    }
    ...
    public void capture() {
        CameraInterface.getInstance().takePicture(new CameraInterface.TakePictureCallback() {
            ...
            @Override
            public void captureResult(Bitmap bitmap, boolean isVertical, String path) {
                machine.getView().showPicture(bitmap, isVertical, path);
